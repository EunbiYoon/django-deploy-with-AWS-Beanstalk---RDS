...
from .views import RrequestView, Rmyday_requestView, Rflex_requestView, RmyView, RteamView,RallView, RmydeleteView, RmyexcelView, RteamexcelView, RallexcelView
