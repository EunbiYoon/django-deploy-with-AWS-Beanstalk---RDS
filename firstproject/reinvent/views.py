...
def RrequestView(request):
    ...
    return render(request, 'reinvent/re_request.html', context)
...
def RmyView(request):
    ...
    return render(request, 'reinvent/re_my.html', context)
...
def RteamView(request):
    ...
    return render(request, 'reinvent/re_team.html', context)
...
def RallView(request):
    ...
    return render(request, 'reinvent/re_all.html', context)

    
@login_required
def RmydeleteView(request, data_id):
    if request.method=='POST':
        selected_data=ReinventData.objects.get(pk=data_id)
        # figure out myday
